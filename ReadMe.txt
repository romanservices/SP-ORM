...
SP-ORM is intended to simplify the mapping of objects to stored procedures without the overhead of the larger more robust ORM.  This solves a very specific scenario where business logic layer is the database and all DML fires through stored procedures.  
